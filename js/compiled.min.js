...
mainController.prototype = {
	...
	scrollListener: function () {
		...
		$(window).on( "scroll", function (e) {
			...
			if (_this.portfolioContainer !== undefined && !_this.portfolioContainer.hasClass('loaded') && 
...
portfolioController.prototype = {
	...
	setMaskWidth: function (id, elements) {
		var totalWidth = elements * 100; 
		id.css('width', totalWidth + '%');
		id.attr('data-elements', elements);
	},
	...
	getPortfolio: function () {
		...
		this.model.getPortfolio(function (response) {
			...
			_this.setMaskWidth($id, response.length);
...
$('body').on('click', '#portfolio #backward, #portfolio #forward', function (e) {
	var clicked = $(this),
		...
		items = parseInt(mask.data('elements')),
		...
		if (current >= (items - 2) && type == 2)
			$('#portfolio #forward').addClass('hidden');
		
		if (current == (items - 1) && type != 2)
